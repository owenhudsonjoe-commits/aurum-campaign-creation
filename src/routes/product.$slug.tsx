          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-[1fr_460px] gap-8 lg:gap-16">
            ...
            <div className="md:pt-2">
              ...
              <a
                ...
                className="w-full flex items-center justify-center gap-2 py-3 mb-8 border border-border text-[12px] font-medium text-foreground/60 hover:border-foreground hover:text-foreground transition-colors"
              >
